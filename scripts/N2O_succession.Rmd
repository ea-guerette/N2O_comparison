...
## What 
Tanks are already fairly routinely analysed on the GC-ECD system, so integration really means flask analyses and database integration.
...
* Down the line: Publish entire record + ESSD paper 
